...
public final class EnrollFromScannerForAPI extends BasePanel implements ActionListener {
	...
	public EnrollFromScannerForAPI() {
		super();
                System.out.println("EnrollFromScannerForAPI constructor called...");
		...
		deviceManager.initialize();
                System.out.println("IsDeviceManagerInitiated: " + deviceManager.isInitialized());
	...
	private void startCapturing() {
            System.out.println("startCapturing called...");
		lblInfo.setText("");
		if (FingersTools.getInstance().getClient().getFingerScanner() == null) {
			...
			return;
                ...
                System.out.println("Finger Scanner is: " + FingersTools.getInstance().getClient().getFingerScanner());
        ...
        public void startCapturingAPI() {
            System.out.println("startCapturingAPI called...");
		...
		// Create a finger.
		NFinger finger = new NFinger();
                finger.setCaptureOptions(EnumSet.of(NBiometricCaptureOption.STREAM));
        ...
        public byte[] getScannedImage(){
            System.out.println("getScannedImage called...");
             NBuffer imageBuffer = getSubject().getFingers().get(0).getImage().save(); // Saves image data to NBuffer
	...
	NFingerScanner getSelectedScanner() {
             System.out.println("getSelectedScanner called...: " + scannerList.getSelectedValue());
	...
	protected void updateControls() {
            System.out.println("updateControls is caleed...");
...
//		cbAutomatic.setEnabled(!scanning);
	...
	protected void updateFingersTools() {
                System.out.println("updateFingersTools is caleed...");
	...
	public void updateScannerList() {
                System.out.println("updateScannerList is caleed...");
	...
	public void cancelCapturing() {
            System.out.println("cancelCapturing is caleed...");
	...
	public void actionPerformed(ActionEvent ev) {
                System.out.println("actionPerformed is caleed... and eventSource is: " + ev.getSource());
	...
	private class CaptureCompletionHandler implements CompletionHandler<NBiometricTask, Object> {
		...
		public void completed(final NBiometricTask result, final Object attachment) {
			SwingUtilities.invokeLater(new Runnable() {
				...
				@Override
				public void run() {
                                        System.out.println("CaptureCompletionHandler: ");
